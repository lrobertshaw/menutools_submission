...
process.l1CaloTriggerNtuplizer_pf = process.hgcalTriggerNtuplizer.clone()
process.l1CaloTriggerNtuplizer_pf.Ntuples = cms.VPSet(
    process.ntuple_event,
    #process.ntuple_gen,
    # process.ntuple_egammaEE,
    # process.ntuple_egammaEB,
    #process.ntuple_TTTracks,
    # process.ntuple_tkEleEllEE,
    # process.ntuple_tkEleEllEB,
    # process.ntuple_tkEmEB,
    # process.ntuple_tkEmEE,
    process.ntuple_PFNFegammaEE,
    process.ntuple_PFNFtkEleEE,
    process.ntuple_PFNFtkEmEE,
    process.ntuple_PFNFtkEleEB,
    process.ntuple_PFNFtkEmEB,
...
process.ntuple_step = cms.Path(process.l1CaloTriggerNtuplizer_pf)
